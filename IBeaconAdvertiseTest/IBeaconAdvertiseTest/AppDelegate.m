...
{
    _server = [BeaconServer beaconServer];
    _server.delegate = self;
    _server.uuid = @"45C7447D-BD46-4EC1-AB4F-EA5448D069D6";
    _server.major = @(11);
    _server.minor = @(20);
